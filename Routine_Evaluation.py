...
def main(log_path, GT_Models_path):
    # load the log
    ...
    results_dict = evaluate_clusters_with_jc(infomap_clusters, GT_Models_path)
...
if __name__ == "__main__":
    ...
    GT_Models_path = "GT_Models/Synthetic"
    main(log_path, GT_Models_path)